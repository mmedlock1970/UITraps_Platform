...
def _self_serve_trap_schema(version: str = "v1"):
    """BARE per-Trap (By-Trap) output schema for the KB-only (self-serve) profile. Same
    critical/moderate/minor container the legacy formatter renders, but stripped of all
    guidance: trap names come from the injected KB (no
