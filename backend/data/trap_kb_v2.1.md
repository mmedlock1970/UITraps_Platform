...
**G8. Report architecture — issues first.** The evaluator's goal is not to find and name Traps per se; it is to find and fix user-impacting issues. The Trap vocabulary rides on issues as diagnosis and shared team language. Reports have four sections:
