...
# NOTE: the legacy Pass-3 user-issues HTML renderer (format_issues_report_as_html) was retired
# with the By-Issue report style. get_user_issues_schema + build_synthesis_* remain (dead in
# production, but intact) so these schema/prompt tests still exercise them.
